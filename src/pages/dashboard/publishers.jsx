                      ...
                      <tr key={publisher.id}>
                        ...
                        <td className={className}>
                          <Chip
                            variant="gradient"
                            color={
                              publisher.available_quantity &&
                              publisher.available_quantity === 0
                                ? "red"
                                : publisher.available_quantity > 5
                                ? "green"
                                : "blue-gray"
                            }
                            value={
                        ...
                        <td className={className}>
                          <Chip
                            variant="gradient"
                            color={
                              publisher.is_deleted && publisher.is_deleted === false
                                ? "red"
                                : "green"
                            }
